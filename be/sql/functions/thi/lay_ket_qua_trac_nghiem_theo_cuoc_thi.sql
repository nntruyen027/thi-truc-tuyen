drop function if exists thi.lay_giai_trac_nghiem_theo_cuoc_thi;

create function thi.lay_giai_trac_nghiem_theo_cuoc_thi(
    p_cuoc_thi_id int,
    p_top int
)
    returns jsonb
...
begin
    ...
    with bt0 as (select bt.*
                 from thi.bai_thi bt
                          ...
                          join thi.dot_thi d on d.id = dt.dot_thi_id
