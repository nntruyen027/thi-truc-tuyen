...
declare
    ...
    v_new_id int;
begin
    insert into thi.trac_nghiem_dot_thi(dot_thi_id, linh_vuc_id, nhom_id, loai_cau_hoi, so_luong)
    VALUES (p_dot_thi_id, p_linh_vuc_id, p_nhom_id, coalesce(p_loai_cau_hoi, 'chon_mot'), p_so_luong)
