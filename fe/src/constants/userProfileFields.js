...
export const DEFAULT_USER_PROFILE_FIELDS = [
    ...
    USER_PROFILE_FIELD_KEYS.xaPhuong,
...
export const USER_PROFILE_FIELD_OPTIONS = [
    ...
    {label: "Địa chỉ dòng 1", value: USER_PROFILE_FIELD_KEYS.diaChiDong1},
    {label: "Xã/Phường", value: USER_PROFILE_FIELD_KEYS.xaPhuong},
    {label: "Tỉnh/Thành phố", value: USER_PROFILE_FIELD_KEYS.tinhThanh},
