...
export const DEMO_HONOR_BOARD = {
    "dot-thi": {
        "luot-thi": [
            { donViId: 1, tenDonVi: "Phường Ninh Kiều", soLuongThiSinh: 1480, soNguoiThamGia: 1180 },
            { donViId: 2, tenDonVi: "Phường Vị Tân", soLuongThiSinh: 1312, soNguoiThamGia: 1096 },
            { donViId: 3, tenDonVi: "Phường Cái Răng", soLuongThiSinh: 1275, soNguoiThamGia: 1034 },
            { donViId: 4, tenDonVi: "Xã Vĩnh Thạnh", soLuongThiSinh: 1194, soNguoiThamGia: 1018 },
            { donViId: 5, tenDonVi: "Xã Liêu Tú", soLuongThiSinh: 1090, soNguoiThamGia: 952 },
            { donViId: 6, tenDonVi: "Huyện Cờ Đỏ", soLuongThiSinh: 1014, soNguoiThamGia: 904 },
            { donViId: 7, tenDonVi: "Quận Thốt Nốt", soLuongThiSinh: 1008, soNguoiThamGia: 889 },
            { donViId: 8, tenDonVi: "Huyện Vĩnh Thạnh", soLuongThiSinh: 972, soNguoiThamGia: 870 },
            { donViId: 9, tenDonVi: "Huyện Thới Lai", soLuongThiSinh: 972, soNguoiThamGia: 861 },
            { donViId: 10, tenDonVi: "Quận Ninh Kiều - Khối trường", soLuongThiSinh: 944, soNguoiThamGia: 840 },
        ],
        "nguoi-tham-gia": [
            { donViId: 1, tenDonVi: "Phường Ninh Kiều", soLuongThiSinh: 1480, soNguoiThamGia: 1180 },
            { donViId: 2, tenDonVi: "Phường Vị Tân", soLuongThiSinh: 1312, soNguoiThamGia: 1096 },
    ...
    "cuoc-thi": {
        "luot-thi": [
            { donViId: 1, tenDonVi: "Phường Ninh Kiều", soLuongThiSinh: 3820, soNguoiThamGia: 3050 },
            { donViId: 2, tenDonVi: "Phường Vị Tân", soLuongThiSinh: 3542, soNguoiThamGia: 2928 },
            { donViId: 3, tenDonVi: "Phường Cái Răng", soLuongThiSinh: 3306, soNguoiThamGia: 2741 },
            { donViId: 4, tenDonVi: "Xã Vĩnh Thạnh", soLuongThiSinh: 3258, soNguoiThamGia: 2706 },
            { donViId: 5, tenDonVi: "Xã Liêu Tú", soLuongThiSinh: 3010, soNguoiThamGia: 2522 },
            { donViId: 6, tenDonVi: "Quận Thốt Nốt", soLuongThiSinh: 2876, soNguoiThamGia: 2480 },
            { donViId: 7, tenDonVi: "Huyện Cờ Đỏ", soLuongThiSinh: 2864, soNguoiThamGia: 2418 },
            { donViId: 8, tenDonVi: "Huyện Vĩnh Thạnh", soLuongThiSinh: 2778, soNguoiThamGia: 2364 },
            { donViId: 9, tenDonVi: "Huyện Thới Lai", soLuongThiSinh: 2778, soNguoiThamGia: 2310 },
            { donViId: 10, tenDonVi: "Khối các sở, ban, ngành", soLuongThiSinh: 2605, soNguoiThamGia: 2296 },
        ],
        "nguoi-tham-gia": [
            { donViId: 1, tenDonVi: "Phường Ninh Kiều", soLuongThiSinh: 3820, soNguoiThamGia: 3050 },
            { donViId: 2, tenDonVi: "Phường Vị Tân", soLuongThiSinh: 3542, soNguoiThamGia: 2928 },
